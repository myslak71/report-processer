...
class TestCsvReportProcesser(unittest.TestCase):
    ...
    def test_valid_csv_report_processing(self):
        self.assertEqual(ReportProcesser.csv_report_processing(self.BASE_DIR + 'input_utf_8.csv',
    ...
    def test_csv_report_processing_invalid_date(self):
        self.assertEqual(ReportProcesser.csv_report_processing(self.BASE_DIR + 'input_invalid_date.csv',
                                                               self.BASE_DIR + 'output_utf_8.csv'),
                         'Invalid date format')

    def test_csv_report_processing_converts_to_xxx(self):
        ReportProcesser.csv_report_processing(self.BASE_DIR + 'input_converts_to_xxx.csv',
                                              self.BASE_DIR + 'output_utf_8.csv')
