...
INVALID_DATE_OUTPUT = """0sad1/21/2019,GIN,883,3
...
INVALID_IMPRESSIONS_ERROR = """2019-01-21,GIN,88asd3,0.38%"""
...
__all__ = ['VALID_OUTPUT', 'INPUT_DFS', 'INVALID_DATE_OUTPUT', 'INVALID_IMPRESSIONS_OUTPUT', 'INVALID_DATE_ERROR',
